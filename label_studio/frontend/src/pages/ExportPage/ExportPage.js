  ...
  return (
    <Block name="formats">
      ...
      <Elem name="feedback">
        ...
        <br/>
        Please let us know in <a className="no-go" href="https://sygmai.slack.com/?source=product-export">Slack</a> or submit an issue to the <a className="no-go" href="/issues">Repository</a>
      </Elem>
    </Block>
  );
};
