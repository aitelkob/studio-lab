  ...
  return (
    <Block name="invite">
      ...
      <Description style={{ width: '70%', marginTop: 16 }}>
        Invite people to join your Sygma Studio instance. People that you invite have full access to all of your projects. <a href="/guide/signup.html">Learn more</a>.
      </Description>
    </Block>
  );
};
